...
function noo_render_metabox_fields( $post, $id, $type, $meta, $std, $field = null ) {
	switch ( $type ) {
        ...
        case 'resume_select_tax':
            ...
            $tax = str_replace('_job_', 'job_', $field['id']);
            ...
            $field_args = array(
                ...
                'name' => $field_name,
                'id' => $id,
                'class' => 'form-control noo-select form-control-chosen noo-admin-chosen',
                'depth' => 0,
                'taxonomy' => $tax,
                'value_field' => 'term_id',
                'orderby' => 'name',
		...
		case 'location_picker':
            ...
            if ($map_type == "google") {
                ...
                <div class="noo-mb-job-location-wrap">
                    ...
                    <input type="hidden" class="noo-mb-lat" id="noo-mb-lat" name="noo_meta_boxes[<?php echo esc_attr( $id ) ?>_lat]"
                           value="<?php echo $lat; ?>">
                    <input type="hidden" class="noo-mb-lon" id="noo-mb-lon" name="noo_meta_boxes[<?php echo esc_attr( $id ) ?>_lon]"
                           value="<?php echo $lon; ?>">
                ...
                <div class="noo-mb-job-location-wrap">
                    <div class="map_type">
                        <input id="noo-mb-location-address" class="noo-mb-location-address" type="text" name="noo_meta_boxes[<?php echo esc_attr( $id ) ?>]"
                           value="<?php echo $address; ?>">
                    </div>
                    <input type="hidden" id="noo-mb-lat" name="noo_meta_boxes[<?php echo esc_attr( $id ) ?>_lat]"
                           value="<?php echo $lat; ?>">
                    <input type="hidden" id="noo-mb-lon" name="noo_meta_boxes[<?php echo esc_attr( $id ) ?>_lon]"
                           value="<?php echo $lon; ?>">
                    <div class="noo-mb-job-location" data-id='<?php echo esc_attr( $id ) ?>'>
...
function noo_save_meta_box( $post_id ) {
	...
	foreach($fields as $field){
        ...
        if(!in_array($id,$_POST['noo_meta_boxes'])){
